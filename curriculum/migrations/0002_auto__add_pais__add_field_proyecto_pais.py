...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pais'
        db.create_table(u'curriculum_pais', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descripcion', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'curriculum', ['Pais'])

        # Adding field 'Proyecto.pais'
        db.add_column(u'curriculum_proyecto', 'pais',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['curriculum.Pais'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Pais'
        db.delete_table(u'curriculum_pais')

        # Deleting field 'Proyecto.pais'
        db.delete_column(u'curriculum_proyecto', 'pais_id')
